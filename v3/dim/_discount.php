<?php
	...
	$host = 'https://online.moysklad.ru/api/remap/1.1/entity/discount';
	$headers = array(
    ...
    do {
		...
		foreach($result[rows] as $key => $value){
			...
			$stat_result[$resultCount]['allProducts'] = $value[allProducts];
	...
	header('Content-Disposition: attachment; filename=Скидки.csv');
