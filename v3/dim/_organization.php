<?php
	...
	$host = 'https://online.moysklad.ru/api/remap/1.1/entity/organization';
	$headers = array(
    ...
    do {
		...
		foreach($result[rows] as $key => $value){
			...
			$stat_result[$resultCount]['director'] = $value[director];
	...
	header('Content-Disposition: attachment; filename=Организации.csv');
