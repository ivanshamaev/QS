<?php
	...
	$host = 'https://online.moysklad.ru/api/remap/1.1/entity/product';
	$headers = array(
    ...
    do {
		...
		foreach($result[rows] as $key => $value){
			...
			$stat_result[$resultCount]['buyPrice'] = $value[buyPrice][value];
	...
	header('Content-Disposition: attachment; filename=Продукты.csv');
