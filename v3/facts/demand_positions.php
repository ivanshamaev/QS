    ...
    $positionCount = 0;
		...
		foreach($loss_positions as $position_key => $position_value){
				...
				foreach($result[rows] as $key_result => $value_result){
					...
					$stat_result[$resultCount]['demand_id'] = $loss_id; 
					...
					$stat_result[$resultCount]['discount'] = $value_result[discount];
					$stat_result[$resultCount]['vat'] = $value_result[vat];
					$stat_result[$resultCount]['overhead'] = $value_result[overhead];
