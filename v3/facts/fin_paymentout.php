<?php
	...
	if( $mode == "data" ) {	
		...
		foreach($result[rows] as $key => $value){
			...
			$stat_result[$resultCount]['paymentPurpose'] = $value[paymentPurpose];
			...
			$stat_result[$resultCount]['expenseItem_href'] = $value[expenseItem][meta][href];
