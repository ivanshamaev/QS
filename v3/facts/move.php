<?php
	...
	if( $mode == "data" ) {
		...
		foreach($result[rows] as $key => $value){
			...
			$stat_result[$resultCount]['sourceStore_href'] = $value[sourceStore][meta][href];
			$stat_result[$resultCount]['targetStore_href'] = $value[targetStore][meta][href];
