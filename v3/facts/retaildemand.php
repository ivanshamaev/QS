<?php
	...
	if( $mode == "data" ) {
		...
		foreach($result[rows] as $key => $value){
			...
			$stat_result[$resultCount]['syncId'] = $value[syncId];
			$stat_result[$resultCount]['sum'] = $value[sum];
			$stat_result[$resultCount]['cashSum'] = $value[cashSum];
			$stat_result[$resultCount]['noCashSum'] = $value[noCashSum];
			...
			$stat_result[$resultCount]['retailStore_href'] = $value[retailStore][meta][href];
			$stat_result[$resultCount]['retailShift_href'] = $value[retailShift][meta][href];
