<?php
	...
	if( $mode == "data" ) {
		...
		foreach($result[rows] as $key => $value){
			...
			$stat_result[$resultCount]['project_href'] = $value[project][meta][href];
			...
			$stat_result[$resultCount]['proceedsCash'] = $value[proceedsCash];
			$stat_result[$resultCount]['receivedCash'] = $value[receivedCash];
			$stat_result[$resultCount]['proceedsNoCash'] = $value[proceedsNoCash];
			$stat_result[$resultCount]['receivedNoCash'] = $value[receivedNoCash];
