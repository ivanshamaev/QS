	...
	if( $mode == "data" ) {
		...
		$stat_result = array();
			...
			foreach($result[rows] as $key => $value){
				...
				$stat_result[$resultCount]['vatEnabled'] = $value[vatEnabled];
				$stat_result[$resultCount]['vatIncluded'] = $value[vatIncluded];
				$stat_result[$resultCount]['vatSum'] = $value[vatSum];
				//href
